<?php
   ...
   * @author a2ngsa
   * @copyright 2012
   * @version $Id: ptk_edit.php (registered), v1.00 2011-06-05 10:12:05 gewa Exp $
   */
...
<script type="text/javascript" src="js/ptk_edit.js"></script>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->    
                ...
                <div class="heading">
                    <h3>
                        <span>Data Pengajar dan Tenaga Kependidikan (PTK)</span>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <?php 
                            $row = $content->getPTKById($user->ptkid);
                            if (!$row):
                        ?>

                            <div class="alert alert-error">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Data PTK invalid!</strong> Data sudah dihapus atau ada kesalahan sistem!
                            </div>
                                ...
                                <div class="tab-pane fade in active" id="tab1">
                                    ...
                                    <div class="form-row row-fluid">
                                        <div class="span12">
                                            <div class="row-fluid">
                                                ...
                                                <div class="span4 controls">
                                                    <select name="sek_propinsi_kode" id="sek_propinsi_kode" style="width:350px;">
                                    ...
                                    <div class="form-row row-fluid">
                                        <div class="span12">
                                            <div class="row-fluid">								
                                                ...
                                                <div class="span4 controls">
                                                    <select name="sek_kota_kode" id="sek_kota_kode">
                                                        <option value=""><?php echo lang('SELECT');?></option>
                                                        <?php if ($kota):?>
                                    ...
                                    <div class="form-row row-fluid">
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">								
                                                    <span class="green"><label class="form-label span2" for="checkboxes">Tingkat Pendidikan:</label></span>
                                                    <div class="span4 controls">
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">								
                                                    ...
                                                    <input type="text" class="span2" name="tahun_lulus_akhir" id="tahun_lulus_akhir" value="<?php echo $row->tahun_lulus_akhir;?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">								
                                                    ...
                                                    <label class="form-label span4" for="UKA_tahun">Tahun Lulus UKA:</label>
                                                    <div class="span2 controls">
                                                        <input type="text" name="UKA_tahun" id="UKA_tahun" value="<?php echo $row->UKA_tahun;?>"/>
                                                    </div>    
                                                </div>
                                            </div>
                                        </div>                                        
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">								
                                                    ...
                                                    <label class="form-label span4" for="UKG_tahun">Tahun Lulus UKG:</label>
                                                    <div class="span2 controls">
                                                        <input type="text" name="UKG_tahun" id="UKG_tahun" value="<?php echo $row->UKG_tahun;?>"/>
                                                    </div>    
                                                </div>
                                            </div>
                                        </div>                                        
                                        ...
                                        <input name="id" type="hidden" value="<?php echo $user->ptkid;?>" />
        ...
        <div id="delModal" class="modal fade hide" style="display: none;">
            ...
            <div class="modal-body">					
                <ul class="unstyled">
                    <li><span class="ui-icon ui-icon-alert"></span>Hapus ?</li>
                </ul>
            </div>
...
<?php echo Core::doForm("processUpdatePTK", "ajax/controller.php"); ?>
