                            ...
                            <div class="content">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row row-fluid">
                                        <div class="span12">
                                            <div class="row-fluid">
                                                <label class="form-label span3" for="checkboxes">Gunakan untuk Login :
                                                    <span class="help-block">Nama user digunakan saat login</span></label>
                                                <div class="span8 controls">
                                                    <div class="left marginT5">	
                                                        <input type="radio" name="umode" id="opt_nuptk" value="1" checked="checked" />NUPTK&nbsp;&nbsp;&nbsp;
                                                    </div>
                                                    <div class="left marginT5">	
                                                        <input type="radio" name="umode" id="opt_nip" value="2" />NIP
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row row-fluid">
                                        <div class="span12">
                                            <div class="row-fluid">
                                                <label class="form-label span3" for="normal">Sekolah:</label>
                                                <input name="nama_sekolah" id="nama_sekolah" type="text" class="span9" maxlength="60" disabled="disabled"/>
                                                <span class="help-inline orange"><a href="registerbaru.php">Klik disini jika data anda tidak ditemukan.</a></span>
                                            </div>
                                        </div>
                                    </div>                                    
                    ...
                    $.ajax({
                            ...
                            success: function (msg) {
                                  $("#msgholder").ajaxComplete(function(event, request, settings) {
                                      ...
                                      if(msg.trim() === 'OK') {
                                          hideLoader();
                                          result = '<div class="alert alert-success"><h4 class="alert-heading">Registrasi PTK berhasil</h4>Anda bisa melakukan <button type="button" class="btn btn-warning" onclick="location.href=\'index.php\'">Login</button> dan melengkapi data identitas selanjutnya atau melakukan TNA Online.</div>';
                                          $(".box").hide();
                                      } else {
                                        hideLoader();
                                        result = msg;					  
