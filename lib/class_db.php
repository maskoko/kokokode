<?php
  ...
  class Database
  {
       ...
       * @return array
       */
      public function fetch($query_id = -1, $type = false)
      {
          if ($query_id != -1)
              $this->query_id = $query_id;
          
          if (isset($this->query_id)) {
              $record = ($type) ? mysql_fetch_array($this->query_id, MYSQL_ASSOC) : mysql_fetch_object($this->query_id);
          } else
