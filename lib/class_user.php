<?php
  ...
  class Users
  {
    ...
    /**
	  ...
	  {
	      $arr = array('A' => 'A : Administrator', 'P' => 'P : PTK', 'R' => 'R : Asrama', 
          'D' => 'D : Data Info', 'O' => 'O : Operator', 'V' => 'V : Seksi Evaluasi', 'Y' => 'Y : Seksi Penyelenggara',
          'S' => 'S : Staff', 'K' => 'K : Struktural', 'E' => 'E : Departemen');
      ...
      public function registerPTK()
      {
          ...
          if (empty(Filter::$msgs)) {
              ...
              if (!$ptkid) {
                    ...
                    self::$db->insert(self::uTable, $data);
                    (self::$db->affected()) ? print 'OK' : Filter::msgError('Data PTK tidak berhasil diproses! Silahkan kontak Administrator.', false);                        
