<?php
   ...
   * @author a2ngsa
   * @copyright 2012
   * @version $Id: diklat_peserta_public.php, v1.00 2011-07-10 10:12:05 gewa Exp $
   */
                            ...
                            <div class="content">
                                ...
                                <fieldset>
                                   ...
                                   <div class="form-row row-fluid">
                                       <div class="span12">
                                           <div class="row-fluid">
                                                <label class="form-label span2" for="jadwal_tgl_dari">Periode Diklat:</label>
                        ...
                        <table class="responsive table table-bordered table-striped table-sorting table-condensed">
                            ...
                            <?php foreach ($rows as $row):?>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="javascript:void(0)" data-id="<?php echo $row->id; ?>" title="View" class="tip view" data-toggle="modal"><span class="icon12 icomoon-icon-search-3"></span></a>
                                    </td>
                                </tr>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
              ...
              $(".sorting, .sorting_asc, .sorting_desc").click(function(){
                  ...
                  //alert (sortfield + ", class : " + tclass + " serialize : " + values);
                  //location.href = "diklat_peserta_public.php?" + values + "&sortfield=" + sortfield + "&sorttype=" + sorttype;
                  location.href = "diklat_peserta_public.php?" + values;
              });
