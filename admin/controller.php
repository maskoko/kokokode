...
<?php
  /* == Update Kategori ==================================================================================================================== */
  if (isset($_POST['processUpdateKategori']))
      : if (intval($_POST['processUpdateKategori']) == 0 || empty($_POST['processUpdateKategori']))
      : die();
  endif;
  ...
  /* == Add Kategori == */
  if (isset($_POST['processAddKategori']))
      : if (intval($_POST['processAddKategori']) == 0 || empty($_POST['processAddKategori']))
      : die();
  endif;
  ...
  if (isset($_POST['deleteKategori']))
      : if (empty($_POST['deleteKategori']))
      : die();
  endif;
  
  $id = intval($_POST['deleteKategori']);
 
  $res = $db->delete("Kategori", "kode=" . $id);
  ...
  /* == Load KategoriList == */
  if (isset($_POST['getKategoriList'])):
      if ($_POST['getKategoriList'] == '' || empty($_POST['getKategoriList'])):
          die();
      endif;
...
<?php
  /* == Update Materi ==================================================================================================================== */
  if (isset($_POST['processUpdateMateri']))
      : if (intval($_POST['processUpdateMateri']) == 0 || empty($_POST['processUpdateMateri']))
      : die();
  endif;
  ...
  /* == Add Materi == */
  if (isset($_POST['processAddMateri']))
      : if (intval($_POST['processAddMateri']) == 0 || empty($_POST['processAddMateri']))
      : die();
  endif;
  ...
  if (isset($_POST['deleteMateri']))
      : if (empty($_POST['deleteMateri']))
      : die();
  endif;
  
  $id = intval($_POST['deleteMateri']);
 
  $res = $db->delete("Materi", "id=" . $id);
  ...
  /* == Load MateriList == */
  if (isset($_POST['getMateriList'])):
      if ($_POST['getMateriList'] == '' || empty($_POST['getMateriList'])):
          die();
      endif;
...
<?php
  ...
  /* == update Registrasi Awal Diklat_Peserta == */
  if (isset($_POST['regawalDiklat_Peserta'])):
      if (intval($_POST['regawalDiklat_Peserta']) == 0 || empty($_POST['regawalDiklat_Peserta'])):
          die();
      endif;

      Filter::$id = intval($_POST['regawalDiklat_Peserta']);
