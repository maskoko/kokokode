                                    ...
                                    <table class="responsive table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Nama Gedung</th>
                                                <th>Jml Kamar</th>
                                                <th style="<?php if(!$user->isProfileModuleExists('12', 'U')){echo 'display:none;';}?>" width="100"><button type="button" class="btn btn-mini" onclick="location.href='index.php?do=pn_gedung&amp;action=add'"><span class="icon16 icomoon-icon-plus-2"></span>Tambah</button></th>
                                            </tr>
                                        </thead>
                                        ...
                                        <?php foreach ($rows as $row):?>
                                            ...
                                            <tr>
                                                ...
                                                <td  style="<?php if(!$user->isProfileModuleExists('12', 'U')){echo 'display:none;';}?>" align="center">
