<?php
   ...
   * @author a2ngsa
   * @copyright 2012
   * @version $Id: report_sekolah.php (admin), v1.00 2011-06-05 10:12:05 gewa Exp $
   */
                        ...
                        <div class="box">
                            <div class="title">
                                <h4>
                                    ...
                                    <div class="right">
                                        <a href="controller_report.php?action=createReportSekolah<?php echo '&amp;propinsi_kode='.$propinsi_kode.'&amp;kota_kode='.$kota_kode.'&amp;searchfield='.$searchfield.'&amp;searchtext='.$searchtext; ?>" class="tip" title="Export"><span class="icon16 icomoon-icon-file-excel"></span></a>
                                        <a href="controller_print.php?action=createPrintSekolah<?php echo '&amp;propinsi_kode='.$propinsi_kode.'&amp;kota_kode='.$kota_kode.'&amp;searchfield='.$searchfield.'&amp;searchtext='.$searchtext; ?>" class="tip" title="Print" target="_blank"><span class="icon24 icomoon-icon-printer-2"></span></a>
                                    </div>
                            ...
                            <div class="content">
                                ...
                                <fieldset>
                                    <input type="hidden" name="do" value="report_sekolah">
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span2 controls">
                                                    <select name="searchfield" id="searchfield" placeholder="Select..." style="width: 100%;">
                                                        <option value="nama_sekolah" <?php if($searchfield == 'nama_sekolah') echo 'selected="selected"';?>>Nama</option>
                    ...
                    <div class="span12">
                        ...
                        <table class="responsive table table-bordered">
                            ...
                            <?php foreach ($rows as $row):?>
                                ...
                                <tr>
                                    <td style="text-align: left;"><?php echo $row->nss;?></td>
