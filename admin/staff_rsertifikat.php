<?php
   ...
   * @author a2ngsa
   * @copyright 2012
   * @version $Id: staff_rsertifikat.php (admin), v1.00 2011-06-05 10:12:05 gewa Exp $
   */
...
?>
	...
	<div id="RSertifikatModal" class="modal hide fade" style="display: none;">
            ...
            <div class="modal-body">		
                ...
                <fieldset>
                    <input name="processRSertifikat" type="hidden" value="1">
                    
                    <div class="form-row row-fluid">
                        <div class="span12">
                            <div class="row-fluid">								
                                <label class="form-label span4" for="normal">NSS:</label>
                                <input type="text" class="span4" name="nss" id="rsert_nss" maxlength="30" value=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row row-fluid">
                        <div class="span12">
                            <div class="row-fluid">
                                ...
                                <input type="text" class="span4" name="nip" id="rsert_nip" maxlength="20" value=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row row-fluid">
                        <div class="span12">
                            <div class="row-fluid">
                                ...
                                <input type="text" class="span6" name="nama_sertifikat" id="rsert_nama_sertifikat" maxlength="100" value=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row row-fluid">
                        <div class="span12">
                            <div class="row-fluid">
                                ...
                                <input type="text" class="span6" name="pelaksana" id="rsert_pelaksana" maxlength="100" value=""/>
                            </div>
                        </div>
                    </div>
	...
	<script type="text/javascript">
            ...
            function loadRSertifikatList() {
                    ...
                    $.ajax({
                            ...
                            data: 'loadRSertifikat=' + <?php echo Filter::$id;?>,
                            cache: false,
                            success: function (html) {
                                    $("#staff_rsertifikat").html(html);
                            }
                    });
                    $('#loader').fadeOut(200);
            }                        
            ...
            $(document).ready(function() {
                ...
                $('#btnRSertifikatadd').live('click', function () {
                    ...
                    $('input[name=nss]', '#rsertifikat_form').val('');
                    $('input[name=nip]', '#rsertifikat_form').val('');
                ...
                $('.tip.doEditrsertifikat').live('click', function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                $('input[name=nss]', '#rsertifikat_form').val(res.data.nss);
                                $('input[name=nip]', '#rsertifikat_form').val(res.data.nip);
