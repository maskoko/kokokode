 ...
 <script type="text/javascript">
  ...
  }}    $(document).ready(function () {       	$('.validatenumber').keyup(function(){		if ($(this).val() > 100){			$(this).val('100');		}		});    });	</script>
                        ...
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <fieldset>							
                                    ...
                                    <table class="responsive table table-striped table-bordered">
                                        ...
                                        <?php $i = 0; foreach ($dmtrows as $dmtrow): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
												<!--Author Muiz-->
                                                    <input type="text" onkeypress="validate(event);" class="span2 required validatenumber" name="nilai[]" id="nilai_<?php echo $dmtrow->id;?>" value="<?php if ($dmtrow->nilai) echo $dmtrow->nilai;?>" style="width: 56px;"/>
                                                </td>
                                                <td>
                                    ...
                                    <input name="userid" type="hidden" value="<?php echo $user->uid;?>" />																		<input name="jadwalid" type="hidden" value="<?php echo $row->jadwalid;?>" />
