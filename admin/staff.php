<?php
   ...
   * @author a2ngsa
   * @copyright 2012
   * @version $Id: staff.php (admin), v1.00 2011-06-05 10:12:05 gewa Exp $
   */
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span2 controls">
                                                    <select name="searchfield" id="searchfield" placeholder="Select..." style="width: 100%;">
                                                        <option value="s.nama_lengkap" <?php if($searchfield == 'nama_lengkap') echo 'selected="selected"';?>>Nama Staff</option>
                                                        <option value="s.nip" <?php if($searchfield == 'nip') echo 'selected="selected"';?>>NIP</option>
                                                        <option value="s.nuptk" <?php if($searchfield == 'nuptk') echo 'selected="selected"';?>>NUPTK</option>
                                                        <option value="l.nama_lembaga" <?php if($searchfield == 'nama_lembaga') echo 'selected="selected"';?>>Nama Lembaga</option>
                                                    </select>
                                                </div>
...
<?php $rows = $content->getStaff();?>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <table class="responsive table table-striped table-bordered table-sorting table-condensed">
                            <thead>
                                <tr>
                                    <th id="s.nama_lengkap" <?php
                                        if ($sortfield == "s.nama_lengkap") { 
                                            if ($sorttype == "ASC") 
                                    ...
                                    <th style="<?php if(!$user->isProfileModuleExists('6', 'U')){echo 'display:none;';}?>" width="100"><button type="button" class="btn btn-mini" onclick="location.href='index.php?do=staff&amp;action=add'"><span class="icon16 icomoon-icon-plus-2"></span>Tambah</button></th>
                                </tr>
                            </thead>
                            ...
                            <?php foreach ($rows as $row):?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="<?php if(!$user->isProfileModuleExists('6', 'U')){echo 'display:none;';}?>" align="center">
                                            <a href="index.php?do=staff&amp;action=edit&amp;id=<?php echo $row->id;?>" title="Edit" class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
	...
	<?php echo Core::doDelete(lang('DELCONFIRM_TITLE'), "deleteStaff");?>	
