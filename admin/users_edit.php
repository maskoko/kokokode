                            ...
                            <div class="content">
                                ...
                                <fieldset>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid" id="ptkonly">
                                                    <label class="form-label span4" for="normal">Link Nama PTK / Staff:</label></label>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid" id="ptkonly">								
                                                    <label class="form-label span4" for="normal">Cari : <span class="help-block">(Hanya untuk PTK & Staff : Quick Search)</span></label></label>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid" id="ptkonly">
                                                    <label class="form-label span4" for="normal">Hasil cari PTK / Staff:</label></label>
