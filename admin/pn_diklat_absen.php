                                        ...
                                        <div class="span12">
                                            <div class="row-fluid">											
                                                ...
                                                <div class="span4 controls">
                                                    ...
                                                    ?>
                                                    <select name="jadwalid" id="jadwalid" onchange="window.location='index.php?do=pn_diklat_absen&amp;jadwalid='+this[this.selectedIndex].value+'&amp;tanggal='+document.getElementById('tanggal').value+''" style="width:100%;" placeholder="Select...">
