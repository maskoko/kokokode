                                ...
                                <table class="responsive table table-bordered table-striped table-sorting table-condensed">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="<?php if(!$user->isProfileModuleExists('3', 'U')){echo 'display:none;';}?>" width="110"><button type="button" class="btn btn-mini" onclick="location.href='index.php?do=rujukan_propinsi&amp;action=add'"><span class="icon16 icomoon-icon-plus-2"></span>Tambah</button></th>
                                        </tr>
                                    </thead>
