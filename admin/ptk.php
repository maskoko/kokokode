                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span2 controls"> 
                                                     <select name="searchfield" id="searchfield" placeholder="Select..." style="width: 100%;">
                                                         <option value="nama_lengkap" <?php if($searchfield == 'nama_lengkap') echo 'selected="selected"';?>>Nama GTK</option>
                        ...
                        <table class="responsive table table-bordered table-striped table-sorting table-condensed">
                            <thead>
                                <tr>
                                    ...
                                    <th style="<?php if(!$user->isProfileModuleExists('4', 'U')){echo 'display:none;';}?>" width="100"><button type="button" class="btn btn-mini" onclick="location.href='index.php?do=ptk&amp;action=add'"><span class="icon16 icomoon-icon-plus-2"></span>Tambah</button></th>
                                </tr>
                            </thead>
                            ...
                            <?php foreach ($rows as $row):?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="<?php if(!$user->isProfileModuleExists('4', 'U')){echo 'display:none;';}?>" align="center">
