<?php
   ...
   * @author PPPTK
   * @copyright 2012
   * @version $Id: rujukan_kategori.php (admin), v1.00 2011-06-05 10:12:05 gewa Exp $
   */
...
<?php switch(Filter::$action): case "edit": ?>
                            ...
                            <div class="content">
                                ...
                                <?php $row = Core::getRowByKey("kategori", "kode", Filter::$get['kode']);?>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row row-fluid">
                                        <div class="span12">
                                            <div class="row-fluid">								
                                                <label class="form-label span4" for="normal">Nama Kategori:</label>
                                                <input type="text" class="span8 required" name="nama_kategori" id="nama_kategori" value="<?php echo $row->nama_kategori;?>"/>
                                            </div>
                                        </div>
                                    </div>
		  ...
		  <script type="text/javascript">
			  ...
			  $(document).ready(function () {
                                var options = {
                                        ...
                                        clearForm : 0,
                                        data: {
                                                processUpdateKategori: '<?php echo Filter::$get['kode']; ?>'
                                        }
                                };
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row row-fluid">
                                        <div class="span12">
                                            <div class="row-fluid">								
                                                <label class="form-label span4" for="normal">Nama Kategori:</label>
                                                <input type="text" class="span8 required" name="nama_kategori" id="nama_kategori" value=""/>
                                            </div>
                                        </div>
                                    </div>
...
<?php default: ?>
	...
	<?php 
        ...
        ?>
                                ...
                                <table class="responsive table table-bordered table-striped table-sorting table-condensed">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="<?php if(!$user->isProfileModuleExists('3', 'U')){echo 'display:none;';}?>" width="110"><button type="button" class="btn btn-mini" onclick="location.href='index.php?do=rujukan_kategori&amp;action=add'"><span class="icon16 icomoon-icon-plus-2"></span>Tambah</button></th>
                                        </tr>
                                    </thead>
                                        ...
                                        <?php foreach ($rows as $row):?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="<?php if(!$user->isProfileModuleExists('3', 'U')){echo 'display:none;';}?>" align="center">
                                                    <a href="index.php?do=rujukan_kategori&amp;action=edit&amp;kode=<?php echo $row->kode;?>" title="Edit" class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
                            ...
                            <?php echo Core::doDelete(lang('DELCONFIRM_TITLE'), "deleteKategori");?>	
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
              ...
              $(".sorting, .sorting_asc, .sorting_desc").click(function(){
                    ...
                    location.href = "index.php?do=rujukan_kategori&sortfield=" + sortfield + "&sorttype=" + sorttype;
