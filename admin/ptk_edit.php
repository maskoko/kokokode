    <script type="text/javascript" src="js/ptk_edit.js"></script>
                ...
                <div class="heading">
                    <h3><span>Data Guru dan Tenaga Kependidikan (GTK)</span>
                                            ...
                                            <div class="span12">
                                                <div class="row-fluid">                             
                                                    ...
                                                    <div class="span2 controls">
                                                         ...
                                                         <img src='../foto/foto_ptk/<?php echo ( ($row->foto) ? ($row->dir_foto).'/'.($row->foto) : 'poto_kosong.png');?>   ' title='Poto Peserta' id="poto_peserta" name="poto_peserta" width="150" height="120"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">                             
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" id="foto" name="foto" accept=".jpg,.jpeg;capture=camera">
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">                             
                                                    ...
                                                    <div class="span2 controls">
                                                        <input type="text" class="required" name="nuptk" id="nuptk" value="<?php echo $row->nuptk;?>" maxlength="16"/>
                                                    </div>
                                                    ...
                                                    <div class="span2 controls">
                                                        <input type="text" name="nip" id="nip" value="<?php echo $row->nip;?>" maxlength="18"/>
                                                    </div>
                                                    ...
                                                    <div class="span2 controls">
                                                        <input type="text" class="required" name="nopesukg" id="nopesukg" value="<?php echo $row->nopesukg;?>" maxlength="12"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="span12">
                                            ...
                                            <div class="box gradient">                                                
                                                ...
                                                <div class="content" id="ptk_mmds">
                                                    ...
                                                    <?php 
                                                    $mmdsrows = $content->getPTK_MMDS($row->id);
                                                    // $mmds1rows = $content->getPTK_MMDS_jenissekolah($row->id);
                                                     $jenissekolah = "";
                                                     // $jenissekolah = $mmds1rows['jenisid'];
                                                 ...
                                                 <!--   <?php foreach ($mmdsrows as $mmdsrow){ 
                                                    $jenissekolah = $mmdsrow->jenisid;
                                                    } ?> -->
                                                    

                                                    <table class="responsive table table-striped table-bordered">
                                                        <?php if($row->jenisid == 1){ ?>

                                                        <thead>
                                                            <tr>
                                                                <th width="80">Bidang Keahlian </th>
                                                                <th>Program Keahlian (KK)</th>
                                                        ...
                                                        <?php foreach ($mmdsrows as $mmdsrow):?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;"><?php echo $mmdsrow->nama_program;?></td>
                                                                    <?php } ?>
                                                                    ...
                                                                    <td align="center">
                                                                        <a href="javascript:void(0)" title="Edit" class="tip doEditmmds" data-tname="ptk_mmds" data-id="<?php echo $mmdsrow->id;?>" data-jenissekolah="<?php echo $row->jenisid;?> data-toggle="modal"><span class="icon12 icomoon-icon-pencil"></span></a>
                                                    ...
                                                    <table class="responsive table table-striped table-bordered">
                                                        ...
                                                        <?php foreach ($mmdlrows as $mmdlrow):?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <a href="javascript:void(0)" title="Edit" class="tip doEditmmdl" data-tname="ptk_mmdl" data-id="<?php echo $mmdlrow->id;?>" data-jenissekolah="<?php echo $row->jenisid;?> data-toggle="modal"><span class="icon12 icomoon-icon-pencil"></span></a>
