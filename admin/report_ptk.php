<?php
   ...
   * @author a2ngsa
   * @copyright 2012
   * @version $Id: report_ptk.php (admin), v1.00 2011-06-05 10:12:05 gewa Exp $
   */
...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    <h3>Laporan Data Pengajar dan Tenaga Kependidikan (PTK)</h3>                    
                </div><!-- End .heading-->
                        ...
                        <div class="box">
                            <div class="title">
                                <h4>
                                    ...
                                    <div class="right">
                                        <a href="controller_report.php?action=createReportPTK<?php echo '&amp;propinsi_kode='.$propinsi_kode.'&amp;kota_kode='.$kota_kode.'&amp;searchfield='.$searchfield.'&amp;searchtext='.$searchtext; ?>" class="tip" title="Export"><span class="icon16 icomoon-icon-file-excel"></span></a>
                                        <a href="controller_print.php?action=createPrintPTK<?php echo '&amp;propinsi_kode='.$propinsi_kode.'&amp;kota_kode='.$kota_kode.'&amp;searchfield='.$searchfield.'&amp;searchtext='.$searchtext; ?>" class="tip" title="Print" target="_blank"><span class="icon24 icomoon-icon-printer-2"></span></a>
                                    </div>
                            ...
                            <div class="content">
                                ...
                                <fieldset>
                                    <input type="hidden" name="do" value="report_ptk">
                            ...
                            <?php foreach ($rows as $row):?>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;">
                                        <?php if ($row->gelar_depan1 != '') echo $row->gelar_depan1.' ';
