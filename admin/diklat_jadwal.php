                        ...
                        <table class="responsive table table-striped table-bordered table-sorting table-condensed">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>Departemen</th>
                                    <th style="<?php if(!$user->isProfileModuleExists('9', 'U')){echo 'display:none;';}?>" width="100">
                                    <a href="controller_report.php?action=createReportDiklat_Jadwal2<?php echo "&amp;tgl_dari=".$jadwal_tgl_dari."&amp;tgl_sampai=".$jadwal_tgl_sampai."&amp;departemenid=".$departemenid; ?>" class="tip" title="Export"><span class="icon16 icomoon-icon-file-excel"></span></a>
                                       <button type="button" class="btn btn-mini" onclick="location.href='index.php?do=diklat_jadwal&amp;action=add'"><span class="icon16 icomoon-icon-plus-2"></span></button>
                                   </th>
                                </tr>
                            </thead>
                            ...
                            <?php foreach ($rows as $row):?>
                                ...
                                <tr>
                                    ...
                                    <td style="<?php if(!$user->isProfileModuleExists('9', 'U')){echo 'display:none;';}?>" class="actBtns">
