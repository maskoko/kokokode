<?php
   ...
   * @author a2ngsa
   * @copyright 2012
   * @version $Id: report_diklat_calonpeserta.php (admin), v1.00 2011-06-05 10:12:05 gewa Exp $
   */
	...
	?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    <h3>Laporan Calon Peserta Diklat</h3>                    
                </div><!-- End .heading-->
                        ...
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <fieldset>
                                    ...
                                    <input type="hidden" name="do" value="report_diklat_calonpeserta" >
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span2 controls">
                                                    <select name="searchfield" id="searchfield" placeholder="Select..." style="width: 100%;">
                                                        <option value="da.nama_lengkap" <?php if($searchfield == 'dp.nama_lengkap') echo 'selected="selected"';?>>Nama</option>
                                                        <option value="da.nip" <?php if($searchfield == 'dp.nip') echo 'selected="selected"';?>>NIP</option>
                                                        <option value="da.nuptk" <?php if($searchfield == 'dp.nuptk') echo 'selected="selected"';?>>NUPTK</option>
                                                        <option value="da.nama_sekolah" <?php if($searchfield == 'dp.nama_sekolah') echo 'selected="selected"';?>>Nama Sekolah</option>
                                                    </select>
                                                </div>
                        ...
                        <div class="box">
                            ...
                            <div class="title">
                                <h4>
                                    ...
                                    <span>Data Calon Peserta Diklat</span>                                       

                                    <div class="right">
                                        <a href="controller_report.php?action=createReportDiklat_CalonPeserta<?php echo '&amp;jadwalid='.$jadwalid.'&amp;propinsi_kode='.$propinsi_kode.'&amp;kota_kode='.$kota_kode.'&amp;searchfield='.$searchfield.'&amp;searchtext='.$searchtext; ?>" class="tip" title="Export"><span class="icon16 icomoon-icon-file-excel"></span></a>
