<?php
   ...
   * @author a2ngsa
   * @copyright 2012
   * @version $Id: report_ptk_diklatminat.php (admin), v1.00 2011-06-05 10:12:05 gewa Exp $
   */
...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    <h3>Laporan Data Minat Diklat GTK</h3>                    
                </div><!-- End .heading-->
                        ...
                        <div class="box">
                            <div class="title">
                                <h4>
                                    ...
                                    <div class="right">
                                        <a href="controller_report.php?action=createReportPTK_DiklatMinat<?php echo '&amp;propinsi_kode='.$propinsi_kode.'&amp;kota_kode='.$kota_kode.'&amp;diklatid='.$diklatid.'&amp;diklat_tahun='.$diklat_tahun.'&amp;searchfield='.$searchfield.'&amp;searchtext='.$searchtext; ?>" class="tip" title="Export"><span class="icon16 icomoon-icon-file-excel"></span></a>
                                        <a href="controller_print.php?action=createPrintPTK_DiklatMinat<?php echo '&amp;propinsi_kode='.$propinsi_kode.'&amp;kota_kode='.$kota_kode.'&amp;diklatid='.$diklatid.'&amp;diklat_tahun='.$diklat_tahun.'&amp;searchfield='.$searchfield.'&amp;searchtext='.$searchtext; ?>" class="tip" title="Print" target="_blank"><span class="icon24 icomoon-icon-printer-2"></span></a>
                                    </div>
                            ...
                            <div class="content">
                                ...
                                <fieldset>
                                    <input type="hidden" name="do" value="report_ptk_diklatminat">
                                    ...
                                    <div class="form-row row-fluid">
                                        <div class="span12">
                                            <div class="row-fluid">
                                                ...
                                                <input class="span2" type="text" name="diklat_tahun" id="diklat_tahun" value="<?php echo $diklat_tahun; ?>" maxlength="4">                                                                                                
                                            </div> <!-- end row-fluid -->
                                        </div>
                                    </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <?php $rows = $content->getPTKByDiklatMinat();?>
                        ...
                        <table class="responsive table table-striped table-bordered">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <?php
                                        if ($diklatid == 0)
                                            echo '<th>Kode Diklat</th><th>Nama Diklat</th><th width="40">Tahun</th>';
                                    ?>
                                </tr>
                            </thead>
                            ...
                            <?php foreach ($rows as $row):?>
                                ...
                                <tr>
                                    ...
                                    <?php
                                    if ($diklatid == 0)
                                        echo '<td style="text-align: left;">' . $row->kode . '</td>' .
