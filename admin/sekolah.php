<?php
   ...
   * @author a2ngsa
   * @copyright 2012
   * @version $Id: sekolah.php (admin), v1.00 2011-06-05 10:12:05 gewa Exp $
   */
	...
	?>
                        ...
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <fieldset>
                                    <input type="hidden" name="do" value="sekolah">
                                        ...
                                        <div class="span12">
                                            <div class="row-fluid">
                                                ...
                                                <div class="span2 controls">
                                                    <select name="searchfield" id="searchfield" class="nostyle">
                    ...
                    <div class="span12">
                        ...
                        <table class="responsive table table-striped table-bordered table-sorting table-condensed">
                                ...
                                <tr>
                                    <th id="s.nss" <?php
                                        if ($sortfield == "s.nss") { 
                                            ...
                                            echo 'class="sorting"'; ?> width="100">NSS</th>
                                    ...
                                    <th id="sj.nama_jenis" <?php
                                        if ($sortfield == "sj.nama_jenis") { 
                                            ...
                                            echo 'class="sorting"'; ?> width="110">Jenis</th>
                                    ...
                                    <th>Nama Pimpinan</th>
                                    <th style="<?php if(!$user->isProfileModuleExists('5', 'U')){echo 'display:none;';}?>" width="100"><button type="button" class="btn btn-mini" onclick="location.href='index.php?do=sekolah&amp;action=add'"><span class="icon16 icomoon-icon-plus-2"></span>Tambah</button></th>
                                </tr>
                            </thead>
                            ...
                            <?php foreach ($rows as $row):?>
                                ...
                                <tr>
                                    <td align="center"><?php echo $row->nss;?></td>
                                    ...
                                    <td style="<?php if(!$user->isProfileModuleExists('5', 'U')){echo 'display:none;';}?>" align="center">
                                        <a href="index.php?do=sekolah&amp;action=edit&amp;id=<?php echo $row->id;?>" title="Edit" class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
        ...
        <?php echo Core::doDelete(lang('DELCONFIRM_TITLE'), "deleteSekolah");?>	
