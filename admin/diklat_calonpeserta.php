                                ...
                                <h4 class="clearfix">
                                    ...
                                    <?php if ($jadwalid != 0):?>                                    
                                        <form class="box-form right" action="">
                                            <div style="<?php if(!$user->isProfileModuleExists('10', 'U')){echo 'display:none;';}?>"  class="btn-group">
                                                <!-- <a href="controller_print.php?action=createPrintDiklat_CalonPeserta<?php echo '&amp;jadwalid='.$jadwalid; ?>" class="tip" title="Print" target="_blank"><span class="icon24 icomoon-icon-printer-2"></span></a> -->
                                                <!-- <a class="btn btn-mini" href="#"> Export</a> -->
                                                <a href="controller_report.php?action=createReportDiklat_CalonPeserta<?php echo '&amp;jadwalid='.$jadwalid; ?>" class="tip" title="Export"><span class="btn btn-mini">Export</span></a>
                                                <a class="btn btn-mini" href="#createPrintDiklat_CalonPeserta"> Tambah</a>
                                                <a class="btn btn-mini dropdown-toggle" data-toggle="dropdown" href="#">
                                                    <span class="icon16 icomoon-icon-plus-2"></span>
                                                    <span class="caret"></span>
                                                </a>
                                                <ul class="dropdown-menu">
                                                    <li><a href="index.php?do=diklat_calonpeserta&amp;action=add&amp;jadwalid=<?php echo $jadwalid; ?>&amp;status=<?php echo $status; ?>&amp;jenis=P"><span class="icon16 icomoon-icon-user-4"></span> GTK</a></li>
                                ...
                                <table class="responsive table table-striped table-bordered table-sorting table-condensed">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="<?php if(!$user->isProfileModuleExists('10', 'U')){echo 'display:none;';}?>"  width="30">Ap 1</th>
                                            <th style="<?php if(!$user->isProfileModuleExists('10', 'U')){echo 'display:none;';}?>"  width="30">Ap 2</th>
                                            <th style="<?php if(!$user->isProfileModuleExists('10', 'U')){echo 'display:none;';}?>"  width="30">Ap 3</th>
                                            <?php if ($jadwalid != 0):?>
                                                <th style="<?php if(!$user->isProfileModuleExists('10', 'U')){echo 'display:none;';}?>"  width="160">Action</th>
                                            <?php endif;?>
                                        </tr>
                                    </thead>
                                    ...
                                    <?php foreach ($rows as $row):?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="<?php if(!$user->isProfileModuleExists('10', 'U')){echo 'display:none;';}?>" >
                                                <?php 
                                                    if ($row->approve1) {
                                            ...
                                            <?php if ($jadwalid != 0):?>
                                                    <td style="<?php if(!$user->isProfileModuleExists('10', 'U')){echo 'display:none;';}?>"  align="center">
                                                        <?php if ($status == "P"):?>
