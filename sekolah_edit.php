                            ...
                            <div style="margin-bottom: 20px;">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1">
                                        ...
                                        <?php 
                                            $row = Core::getRowById("sekolah", $user->sekolahid);
                                        ...
                                        <fieldset>
                                            ...
                                            <input name="id" type="hidden" value="<?php echo $user->sekolahid;?>" />
	...
	<?php echo Core::doForm("processUpdateSekolah", "ajax/controller.php"); ?> 	
