...
<table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="item-desc">A copy of the configuration file will be downloaded to your computer when you click the button 'Download config.ini.php'. You should upload this file to the same directory where you have SIM PPPPTK BMTI Bandung. Once this is done you should log in using the admin credentials you provided on the previous form and configure the software according to your needs.
      <p style="font-weight: bold;">Thank you for choosing SIM PPPPTK BMTI Bandung.</p></td>
  </tr>
  <tr>
