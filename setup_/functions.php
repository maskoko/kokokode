...
<?php
  ...
  function cmsHeader()
  {
      ...
      echo '<head>';
      echo '<title>SIM PPPPTK BMTI Bandung - Web Installer</title>';
  ...
  function cmsFooter()
  {
      ...
      echo '</div>';
      echo '<div id="copyright">SIM PPPPTK BMTI Bandung<br />';
      echo 'Copyright &copy; ' . date("Y") . ' SIM PPPPTK BMTI Bandung';
      echo '</div>';
